...
<div class='container'>  
  ...
  {
  echo "<a href='edit-gambar.php?id=$data[id_image]'><button type='button' class='btn btn-button-outlined btn-lg'><span class='glyphicon glyphicon-pencil'></span></button></a>
  <a href='hapus-gambar.php?id=$data[id_image]'><button type='button' class='btn btn-button-outlined btn-lg'><span class='glyphicon glyphicon-trash'></span></button></a> 
  ";
  }
  else
  {
