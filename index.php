...
<div class='container-fluid custom-container'>
	<div class='row'>
		...
		$sql = mysql_query("SELECT * FROM image JOIN user USING(id_user) order by id_image DESC LIMIT $mulai,$batas WHERE status='sudah_vertifikasi'");
		/*	
	echo "
